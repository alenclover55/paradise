...
function MenuMobileFull({ setOpen }: IProps) {
  return (
    <div className="fixed top-0 left-0 w-screen h-screen bg-[#161A29E6] z-[998] flex flex-col items-center justify-end transition-all">
      <div className=" w-full h-[596px] bg-white dark:bg-[#0C0F1E] p-[10px] rounded-tl-[22px] rounded-tr-[22px]">
        <button
          onClick={() => {
            setOpen(false);
          }}
          className="w-[180px] py-[17px] mb-[20px] mt-[-45px] block mx-auto text-xs font-bold leading-none text-center text-white bg-white bg-opacity-[1%] border border-white rounded-2xl border-opacity-5"
        >
          ЗАКРЫТЬ МЕНЮ
        </button>
        <div className="flex gap-[10px] overflow-y-scroll">
          <div className="w-1/2 ">
            <div className="flex items-center gap-2 my-[17px]">
              <img src="../../assets/icons/all_games.svg" alt="" />
              <span className="text-[#7f89c1] text-xs font-semibold uppercase">
                Все игры
              </span>
            </div>
          ...
          <div className="w-1/2">
            <div className="flex items-center gap-2 my-[17px]">
              ...
              >
                ...
                <path
                  id="Vector"
                  d="M17.08 4.87C17.08 6.23 15.97 7.34 14.61 7.34C13.25 7.34 12.15 6.23 12.15 4.87C12.15 3.51 13.25 2.4 14.61 2.4C15.97 2.4 17.08 3.51 17.08 4.87Z"
                  fill="#7F89C1"
                  fill-opacity="1.000000"
                  fill-rule="evenodd"
                />
                <path
                  id="Vector"
                  d="M7.85 4.87C7.85 6.23 6.74 7.34 5.38 7.34C4.02 7.34 2.91 6.23 2.91 4.87C2.91 3.51 4.02 2.4 5.38 2.4C6.74 2.4 7.85 3.51 7.85 4.87Z"
                  fill="#7F89C1"
                  fill-opacity="1.000000"
                  fill-rule="evenodd"
                />
                <path
                  id="Vector"
                  d="M17.08 15.12C17.08 16.48 15.97 17.59 14.61 17.59C13.25 17.59 12.15 16.48 12.15 15.12C12.15 13.76 13.25 12.65 14.61 12.65C15.97 12.65 17.08 13.76 17.08 15.12Z"
                  fill="#7F89C1"
                  fill-opacity="1.000000"
                  fill-rule="evenodd"
                />
                <path
                  id="Vector"
                  d="M7.85 15.12C7.85 16.48 6.74 17.59 5.38 17.59C4.02 17.59 2.91 16.48 2.91 15.12C2.91 13.76 4.02 12.65 5.38 12.65C6.74 12.65 7.85 13.76 7.85 15.12Z"
                  fill="#7F89C1"
                  fill-opacity="1.000000"
                  fill-rule="evenodd"
                />
              ...
              <span className="text-[rgb(127,137,193)] text-xs font-semibold uppercase">
                МЕНЮ
              </span>
            </div>
            <div className="flex flex-col gap-[15px]">
              <NavLink
                className="nav-link-bottom mobile"
                to={"/referals"}
                onClick={() => setOpen(false)}
              >
                <svg
